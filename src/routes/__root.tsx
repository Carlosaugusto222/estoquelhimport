...
import { LgpdNotice } from "@/components/lgpd-notice";
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "apple-mobile-web-app-title", content: "LH Estoque" },
      { title: "Estoque LH Import" },
      { name: "description", content: "Controle de estoque de telas e baterias da assistência técnica LH Import." },
      { name: "author", content: "LH Import" },
      { property: "og:title", content: "Estoque LH Import" },
    ...
    links: [
      ...
      { rel: "stylesheet", href: "https://fonts.googleapis.com/css2?family=Outfit:wght@600;700&family=Figtree:wght@400;600&display=swap" },
